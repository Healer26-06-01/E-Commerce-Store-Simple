...
const CategoryProduct = ({
    ...
    return (
        <ProductInfoArticle>
            ...
            <aside>
                <ProductInfo>
                    <ProductInfoHeader>Kích thước</ProductInfoHeader>
                    <label>{specs.dimensions}</label>
                </ProductInfo>

                {specs.capacity && (
                    <ProductInfo>
                        <ProductInfoHeader>Dung tích</ProductInfoHeader>
                        <label>{specs.capacity}</label>
                    </ProductInfo>
                )}

                <ProductInfo>
                    <ProductInfoHeader>Đặc trưng</ProductInfoHeader>
                    <ul>
                        {features?.map((f, i) => {
            ...
            <aside>
                ...
                <ProductInfoStock>
                    <ProductInfoStockLabel>Hàng trong kho: {stock}</ProductInfoStockLabel>
                    <ProductInfoStockLabel>MIỄN PHÍ SHIP</ProductInfoStockLabel>
                </ProductInfoStock>
                ...
                <ProductInfoAction>
                    ...
                    <ProductInfoActionButton onClick={() => addProduct({ id, title, price })}>Thêm vào giỏ hàng</ProductInfoActionButton>
                </ProductInfoAction>
            </aside>
        </ProductInfoArticle>
    );
